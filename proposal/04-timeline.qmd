...
|----|----|----|
| **Part-time Developer (0.5 FTE, 8–10 months)** | 30,000 | Skilled in database/API development; designs backend, mentors PI on best practices |
| **Student Assistant (Data Steward, 4h/week, 12 months)** | 4,200 | Supports metadata curation, data validation, Shiny testing |
| **Miscellaneous / Infrastructure** | 500 | small-scale shinyapps.io environment for testing (basic option for 12 months) |
| **Consultancy / Mentorship** | 500 | Contracted expert(s) from the C3RDM department of the University of Cologne (the best RDM practices) |
| **Total** | **35,200** |  |
...
|----|----|----|
| 2 | Database schema + REST API prototype; initial test datasets curated | 7,700 |
| 4 | Extended database + FAIR ingestion pipeline; API documentation draft | 6,700 |
| 6 | QresR R package prototype on GitHub; DGrowthR integration started | 6,700 |
| 8 | Shiny submission system with metadata validation + visualization modules | 6,700 |
| 12 | CRAN release of QresR; tutorials, case studies, community guidelines | 7,400 |
| **Total** |  | **35,200** |

**Notes / Flexibility**

1.  The Consultancy/Mentorship line (€500) and the basic
    [shinyapps.io](https://www.shinyapps.io/#) subscription for 12
    months (€500) can be neglected if reviewers push back on budget.
