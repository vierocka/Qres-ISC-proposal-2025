...
- Medina Feldl (Helmholtz, Munich) – Developer of the DGrowthR package; contributes to Qres integration for bacterial dose–response analysis.
...
## Community Support
The project is known and endorsed within CRC1310 Area A (all PIs listed at crc1310.uni-koeln.de/project_a.html ).
This broad base of support ensures that Qres is well-positioned for adoption and sustainability, with immediate access to diverse microbial dose–response datasets.
